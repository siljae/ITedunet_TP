                    	...
                    	<div class="content_2">
                    		<div>
		                        <div class="colist">
	                                ...
	                                <div>
		                                <a href="./qna/view?num=${board.num }&pageNum=" class="coltitle">${board.title }</a>
		                                <a href="./qna/view?num=${board.num }&pageNum=" class="coltext">${board.content }</a>	                                
		                            </div>
	                            </div>
	                       	    <div class="coreply">
		                            <div class="core1">
                        	...
                        	<c:if test="${board.filename != null }">
		                        <div class="colbox">
		                        	<a href="./qna/view?num=${board.num }&pageNum=" class="imgbox">
