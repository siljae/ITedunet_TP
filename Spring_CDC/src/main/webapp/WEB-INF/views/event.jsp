...
<body>
	...
	<div class="com_name">
		...
		<h1><a href="<c:url value="/board/event"/>" style="color: #090909; border-bottom: 4px solid #fcd11e;">이벤트</a></h1>
    </div>
    <div class="container">
        <div class="midbox">
            <div class="seabox">
                    	...
                    	<div class="content_2">
                    		<div>
		                        <div class="colist">
	                                ...
	                                <div>
		                                <a href="./event/view?num=${board.num }&pageNum=" class="coltitle">${board.title }</a>
		                                <a href="./event/view?num=${board.num }&pageNum=" class="coltext">${board.content }</a>	                                
		                            </div>
	                            </div>
	                       	    <div class="coreply">
		                            <div class="core1">
                        	...
                        	<c:if test="${board.filename != null }">
		                        <div class="colbox">
		                        	<a href="./event/view?num=${board.num }&pageNum=" class="imgbox">
